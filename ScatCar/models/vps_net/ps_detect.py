...
from .utils.vpsnet_utils import non_max_suppression, rescale_boxes, pad_to_square, resize
...
class PsDetect(object):
    ...
    def __init__(self, model_def, model_path, img_size, device):
        ...
        self.model_yolov3.load_state_dict(torch.load(model_path, map_location=device))
