...
from .utils.vpsnet_utils import crop_margin, fixed_ROI
from .Customized import CustomizedAlexNet
...
class vpsClassify(object):
    ...
    def __init__(self, model_path, device):
        ...
        self.model_customized.load(model_path, device)
