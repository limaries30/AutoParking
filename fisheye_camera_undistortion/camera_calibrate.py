    ...
    for image in image_list:
        ...
        if ret:
            ...
            if show_chessboard:
                ...
                cv2.imwrite(os.path.join('C:/Users/한건희/AutoParking/fisheye_camera_undistortion/Chessboards_Corners', image), img)
...
if __name__ == '__main__':
    if not os.path.exists('C:/Users/한건희/AutoParking/fisheye_camera_undistortion/parameters'):
        os.makedirs('C:/Users/한건희/AutoParking/fisheye_camera_undistortion/parameters')
    if not os.path.exists('C:/Users/한건희/AutoParking/fisheye_camera_undistortionChessboards_Corners'):
        os.makedirs('C:/Users/한건희/AutoParking/fisheye_camera_undistortion/Chessboards_Corners')

    K, D, Dims = calibrate('C:/Users/한건희/AutoParking/fisheye_camera_undistortion/Chessboards', show_chessboard=True)
    np.save('C:/Users/한건희/AutoParking/fisheye_camera_undistortion/parameters/Dims', np.array(Dims))
    np.save('C:/Users/한건희/AutoParking/fisheye_camera_undistortion/parameters/K', np.array(K))
    np.save('C:/Users/한건희/AutoParking/fisheye_camera_undistortion/parameters/D', np.array(D))
